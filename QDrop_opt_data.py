...
def main():
    ...
    quant_recon_static(
        executor=exe,
        model_dir='/workspace/distill-gpt/PaddleFleetX-phy/PaddleSlim/example/quantization_analysis/GPT/GPT_345M_Baseline',
        quantize_model_path='./recont_bs4',
    ...
    [program, feed_list, fetch_list] = load_inference_model(
            ...
            FLAGS.pretrain_dir,
            executor=exe,
            #model_filename='model_state.pdmodel',
            #params_filename='model_state.pdiparams')
            model_filename='model.pdmodel',
            params_filename='model.pdiparams')
    ...
    skip_tensor_list.append('layer_norm_95.tmp_2')
    ...
    skip_tensor_list.append('tmp_98')
    '''
    #opt-2.7b model
    '''
    skip_tensor_list.append('tokens')
    skip_tensor_list.append('tmp_0')
    skip_tensor_list.append('embedding_0.w_0')
    skip_tensor_list.append('layer_norm_129.tmp_2')
    skip_tensor_list.append('tmp_130')
    '''

    post_training_quantization = PostTrainingQuantization(
            exe,
            data_loader=data_loader,
            model_dir=FLAGS.pretrain_dir,
            model_filename='model.pdmodel',
            #algo='mse',
            params_filename='model.pdiparams',
    ...
    post_training_quantization.save_quantized_model(FLAGS.pretrain_dir+'/quantized_model',model_filename='model.pdmodel',params_filename='model.pdiparams')
